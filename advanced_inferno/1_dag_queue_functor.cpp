...
void f_copy(sycl::handler &cgh, int global_range, sycl::buffer<int, 1> bufferW,
...
int main(int argc, char **argv) {
  ...
  Q.submit(
      std::bind(f_copy, std::placeholders::_1, global_range, bufferB, bufferA));
  Q.submit(
      std::bind(f_copy, std::placeholders::_1, global_range, bufferC, bufferB));
  Q.submit(
